...
export const StyledMain = styled.main.attrs({
  GridTemplate: props => props.dashboard && `'title title employee-nav employee-nav' 'details content content content' 'details content content content' ` || `'title' 'content'`,
