...
export const eesSchema = Joi.object().keys({
  type: Joi.string()
    .required()
    .error(new Error(`Type is required and should be a string!`)),
  ...
  symbol: Joi.string()
    .required()
    .error(new Error(`Symbol is required and should be a string`)),
  percent: Joi.number()
    .required()
    .error(new Error(`Percent is required and should be a string`)),
