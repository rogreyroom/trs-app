...
import { getCurrentMonthBonusRate, getMonthName, getGivenMonthData, getCurrentMonthWorkedHours, getCurrentMonthOvertimeHours, getCurrentMonthWeekendsHours, getHolidayLeaveDaysForCurrentMonth, getSickLeaveDaysForCurrentMonth, getOtherLeaveDaysForCurrentMonth } from '@/lib/utils'
...
const HrEmployeesBonus = ({ year, month}) => {
    ...
    <StyledHrRtsReport>
      ...
      <StyledPrintArea  ref={tableRef}>
        <StyledPrintAreaHeader>
          <h2>Narzędziownia - <strong>Premia</strong></h2>
