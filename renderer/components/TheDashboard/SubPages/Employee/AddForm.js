  ...
  return (
    <StyledEmployeeForm  onSubmit={handleSubmit(onSubmit)}>
      <StyledAddEmployeeInputsWrapper>
        ...
        <Input name='overdue_leave_amount' type='number' min='0' max='46' step='1' label='Urlop zaległy' error={!!errors.overdue_leave_amount} errorMessage={errors?.overdue_leave_amount && [errorMessages.notEmpty, errorMessages.numericValue]} ref={register} />
        <Input name='assigned_leave_amount' type='number' min='0' max='46' step='1' label='Urlop przysługujący' error={!!errors.assigned_leave_amount} errorMessage={errors?.assigned_leave_amount && [errorMessages.notEmpty, errorMessages.numericValue]} ref={register} />
